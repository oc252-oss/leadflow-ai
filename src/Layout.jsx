...
export default function Layout({ children, currentPageName }) {
  ...
  const navigation = [
    ...
    { type: 'divider' },
    { name: 'WhatsAppChannels', label: 'Conexões', href: createPageUrl('WhatsAppChannels'), icon: MessageSquare, roles: ['company_admin', 'unit_admin', 'brand_manager'] },
    { type: 'divider' },
    ...
    { name: 'ScriptLibrary', label: 'Biblioteca de Scripts', href: createPageUrl('ScriptLibrary'), icon: Bot, roles: ['company_admin', 'unit_admin', 'brand_manager'] },
